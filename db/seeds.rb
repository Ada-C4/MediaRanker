...
albums = [
  ...
  { name: "1990", artist: "Tanner Schmidt", description: "A better take on TayTay", rank: 7},
  { name: "The Harry Potters", artist: "Hermione Granger", description: "Nitwit! Blubbler! Oddment! Tweark!", rank: 6}
]
